                ...
                <div class="row">
                      ...
                      @foreach(config('app.locales') as $lk=>$lv)
                        <div role="tabpanel" class="tab-pane @if($lk=='en') active @endif" id="abc_{{$lk}}">
                          <div class="form-group">
                            ...
                            <input class="form-control"  placeholder="{{trans('advertisements.name')}}" name="name:{{$lk}}" id="name:{{$lk}}" type="text" value="{{$advertisement->translate($lk)->name}}" 
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input class="form-control" type="file" accept=".flv,.mp4,.m3u8,.ts,.3gp,.mov,.avi,.wmv" name="video" id="menu_item_photo">
                      <strong class="help-block">
                        {{ @$errors->first('video') }}
                      </strong>
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control pull-right" name="duration_from" autocomplete="off" id="duration_from" value="{{$advertisement->duration_from}}">
                              <strong class="help-block">
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input name="duration_to" id="duration_to" required class="form-control" readonly type="text" value="{{$advertisement->duration_to}}">
                              <strong class="help-block">
                        ...
                        <div class="form-group">
                          ...
                          <select class="form-control" name="status" id="status" required>
                            <option value="active" 
                              @if($advertisement->status == 'active') selected @endif>
                              {{trans('common.active')}}
                            </option>
                            <option value="inactive" 
                              @if($advertisement->status == 'inactive') selected @endif>
