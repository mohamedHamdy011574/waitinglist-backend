                      ...
                      @foreach(config('app.locales') as $lk=>$lv)
                        <div role="tabpanel" class="tab-pane @if($lk=='en') active @endif" id="abc_{{$lk}}">
                          <div class="form-group">
                            ...
                            <input class="form-control"  placeholder="{{trans('catering_addons.addon_name')}}" name="addon_name:{{$lk}}" id="addon_name:{{$lk}}" type="text" value="{{$catering_addon->translate($lk)->addon_name}}"  
                          ...
                          <div class="form-group">
                            ...
                            <textarea class="form-control"  placeholder="{{trans('catering_addons.description')}}" name="description:{{$lk}}" id="description:{{$lk}}" @if($lk=='en' || $lk=='ar') required @endif>{{$catering_addon->translate($lk)->description}}  </textarea>  
                            <strong class="help-block"></strong>
                          </div>
                        </div>    
                    ...
                    <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input name="addon_rate" required class="form-control" type="number" value="{{$catering_addon->addon_rate}}">
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="form-group">
                          ...
                          <select class="form-control" name="status" id="status" required>
                            <option value="active" 
                              @if($catering_addon->status == 'active') selected @endif>
                              {{trans('common.active')}}
                            </option>
                            <option value="inactive" 
                              @if($catering_addon->status == 'inactive') selected @endif>
