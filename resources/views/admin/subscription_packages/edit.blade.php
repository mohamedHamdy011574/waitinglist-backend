...
@section('content')
  <section class="content-header">
    <h1>
      {{ trans('subscription_packages.edit') }}
    </h1>
    <ol class="breadcrumb">
      <li>
        <a href="{{route('home')}}">
                      ...
                      @foreach(config('app.locales') as $lk=>$lv)
                        <div role="tabpanel" class="tab-pane @if($lk=='en') active @endif" id="abc_{{$lk}}">
                          <div class="form-group">
                            ...
                            <input class="form-control"  placeholder="{{trans('subscription_packages.package_name')}}" name="package_name:{{$lk}}" id="package_name:{{$lk}}" type="text" value="{{$subscription_package->translate($lk)->package_name}}" 
                          ...
                          <div class="form-group">
                            ...
                            <textarea class="form-control" rows="9" placeholder="{{trans('subscription_packages.description')}}" name="description:{{$lk}}" id="description:{{$lk}}"
                              @if($lk=='en') required @endif>{{$subscription_package->translate($lk)->description}}
                            </textarea>
                            <strong class="help-block">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        ...
                        <div class="form-group">
                          ...
                          <input class="form-control" type="number" name="branches_include" id="branches_include" min="1" max="20"
                          @if($subscription_package->package_for == 'catering') readonly @endif value="{{$subscription_package->branches_include}}" required>
                          <strong class="help-block">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input class="form-control" type="number" name="subscription_period" min="1" max="20" value="{{$subscription_package->subscription_period}}"  required>
                          <strong class="help-block">
                        ...
                        <div class="form-group">
                          ...
                          <input class="form-control" type="number" name="package_price" min="1" value="{{$subscription_package->package_price}}"  required>
                          <strong class="help-block">
                        ...
                        <div class="form-group">
                          ...
                          <input class="form-control" type="text" name="currency" value="{{$subscription_package->currency}}" readonly required>
                        </div>
                        <div class="form-group">
                          <label for="status" class="content-label">{{trans('common.status')}}</label>
                          <select class="form-control" name="status" id="status" required>
                            <option value="active" 
                              @if($subscription_package->status == 'active') selected @endif>
                              {{trans('common.active')}}
                            </option>
                            <option value="inactive" 
                              @if($subscription_package->status == 'inactive') selected @endif>
...
<script>
    ...
    @if($subscription_package->for_restaurant == 1)
