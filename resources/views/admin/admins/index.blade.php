...
<section class="content-header">
  <h1>
    {{ trans('admins.heading') }}
  </h1>
  <ol class="breadcrumb">
    <li><a href="{{route('home')}}"><i class="fa fa-dashboard"></i>{{ trans('common.home') }}</a></li>
    <li><a href="{{route('customers.index')}}">{{ trans('admins.plural') }}</a></li>
  </ol>
</section>
    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
          <h3 class="box-title">{{ trans('admins.title') }}
          <h3 class="box-title pull-right"><a href="{{route('admins.create')}}" class="btn btn-danger pull-right">{{trans('admins.add_new')}}</a></h3>
        </div>
        <div class="box-body">
          <table id="admins" class="table table-bordered table-hover">
            <thead>
              <tr>
                ...
                <th>{{ trans('admins.first_name') }}</th>
                <th>{{ trans('admins.last_name') }}</th>
                <th>{{ trans('admins.email') }}</th>
                <th>{{ trans('admins.phone_number') }}</th>
