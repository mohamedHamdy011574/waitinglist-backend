...
<section class="content-header">
  <h1>
    {{ trans('vendors.heading') }}
  </h1>
  <ol class="breadcrumb">
    <li><a href="{{route('home')}}"><i class="fa fa-dashboard"></i>{{ trans('common.home') }}</a></li>
    <li><a href="{{route('customers.index')}}">{{ trans('vendors.plural') }}</a></li>
  </ol>
</section>
    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
          <h3 class="box-title">{{ trans('vendors.title') }}
          <h3 class="box-title pull-right"><a href="{{route('vendors.create')}}" class="btn btn-danger pull-right">{{trans('vendors.add_new')}}</a></h3>
        </div>
        <div class="box-body">
          <table id="vendors" class="table table-bordered table-hover">
            <thead>
              <tr>
                <th>{{ trans('common.id') }}</th>
                <th>{{ trans('vendors.first_name') }}</th>
                <th>{{ trans('vendors.last_name') }}</th>
                <th>{{ trans('vendors.email') }}</th>
                <th>{{ trans('vendors.phone_number') }}</th>
                <th>{{ trans('vendors.business') }}</th>
