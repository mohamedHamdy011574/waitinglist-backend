                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input class="form-control" placeholder="{{trans('vendors.first_name')}}" required="true" name="first_name" type="text" id="first_name" value="{{$vendor->first_name}}">
                    </div>
                    <div class="form-group">
                      <label for="name"> {{trans('vendors.last_name')}}</label>
                      <input class="form-control" placeholder="{{trans('vendors.last_name')}}" required="true" name="last_name" type="text" id="last_name" value="{{$vendor->last_name}}">
                    </div>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input class="form-control" placeholder="{{trans('vendors.email')}}" required="true" name="email" type="text" id="email" value="{{$vendor->email}}">
                    </div>
                    <div class="form-group">
                      <label for="name"> {{trans('vendors.phone_number')}}</label>
                      <input class="form-control" placeholder="{{trans('vendors.phone_number')}}" required="true" name="phone_number" type="number" min="0" id="phone_number" value="{{$vendor->phone_number}}">
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                      <label for="name"> {{trans('vendors.password')}}</label>
                      <input class="form-control" placeholder="{{trans('vendors.password')}}" name="password" type="password" id="password" value="">
                    </div>
                    <div class="form-group">
                      <label for="name"> {{trans('vendors.password_confirmation')}}</label>
                      <input class="form-control" placeholder="{{trans('vendors.password_confirmation')}}" name="password_confirmation" type="password" id="password_confirmation" value="">
                    </div>
                  </div>
                </div>
