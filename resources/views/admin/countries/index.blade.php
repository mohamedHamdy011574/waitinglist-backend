...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="{{route('countries.index')}}">{{trans('countries.title')}}</a></li>
  </ol>
</section>
    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
          ...
          @can('country-create')
          <h3 class="box-title pull-right"><a href="{{route('countries.create')}}" class="btn btn-danger pull-right">{{ trans('countries.add_new') }}</a></h3>
          @endcan
        </div>
        <div class="box-body">
          <table id="country" class="table table-bordered table-hover">
            <thead>
              <tr>
                ...
                <!-- <th>{{trans('countries.dial_code')}}</th> -->
      ...
      columns: [
         ...
         { data: 'status',
            mRender : function(data, type, row) {
                 ...
                 return '<select class="country_status form-control" id="'+row["id"]+'"><option value="active"'+type+'>Active</option><option value="inactive"'+data+'>Inactive</option></select><span class="loading" style="visibility: hidden;"><i class="fa fa-spinner fa-spin fa-1x fa-fw"></i><span class="sr-only">Loading...</span></span>';
              } 
          },
          { 
            mRender : function(data, type, row) {
