                      ...
                      @foreach(config('app.locales') as $lk=>$lv)
                        <div role="tabpanel" class="tab-pane @if($lk=='en') active @endif" id="abc_{{$lk}}">
                          <div class="form-group">
                            ...
                            <input class="form-control"  placeholder="{{trans('restaurant_menus.name')}}" name="name:{{$lk}}" id="name:{{$lk}}" type="text" value="{{$restaurant_menu->translate($lk)->name}}" 
                          ...
                          <div class="form-group">
                            ...
                            <textarea class="form-control" rows="9" placeholder="{{trans('restaurant_menus.description')}}" name="description:{{$lk}}" id="description:{{$lk}}" @if($lk=='en') required @endif>{{$restaurant_menu->translate($lk)->description}}</textarea>
                            <strong class="help-block">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="menu_category">
                        ...
                        @foreach($menu_categories as $mc)
                          <option value="{{$mc->id}}" 
                            @if($restaurant_menu->menu_category_id == $mc->id) selected @endif
                            >{{$mc->name}}</option>
                        @endforeach
                      </select>
                      <strong class="help-block">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input name="price" required class="form-control" type="number" value="{{$restaurant_menu->price}}">
                              <strong class="help-block">
                                {{ @$errors->first('price') }}
                              </strong>
                            </div>
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input name="currency" required class="form-control" readonly type="text" value="{{$restaurant_menu->currency}}">
                              <strong class="help-block">
                        ...
                        <div class="form-group">
                          ...
                          <select class="form-control" name="status" id="status" required>
                            <option value="active" 
                              @if($restaurant_menu->status == 'active') selected @endif>
                              {{trans('common.active')}}
                            </option>
                            <option value="inactive" 
                              @if($restaurant_menu->status == 'inactive') selected @endif>
