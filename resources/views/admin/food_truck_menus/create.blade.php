...
@section('content')
  <section class="content-header">
    <h1>
      {{ trans('food_truck_menus.add_new') }}
    </h1>
    <ol class="breadcrumb">
      <li>
        <a href="{{route('home')}}">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box">
          ...
          <div class="box-body">
            <form method="POST" id="message_templateForm" action="{{route('food_truck_menus.store')}}" accept-charset="UTF-8" enctype="multipart/form-data">
              @csrf
                      ...
                      @foreach(config('app.locales') as $lk=>$lv)
                        <div role="tabpanel" class="tab-pane @if($lk=='en') active @endif" id="abc_{{$lk}}">
                          <div class="form-group">
                            ...
                            <input class="form-control"  placeholder="{{trans('food_truck_menus.name')}}" name="name:{{$lk}}" id="name:{{$lk}}" type="text" value="{{old('name:'.$lk)}}" 
                          ...
                          <div class="form-group">
                            ...
                            <textarea class="form-control" rows="9" placeholder="{{trans('food_truck_menus.description')}}" name="description:{{$lk}}" id="description:{{$lk}}" @if($lk=='en') required @endif>{{old('description:'.$lk)}}</textarea>
                            <strong class="help-block">
